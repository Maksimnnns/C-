...
namespace AvaloniaDatabase.Model
{
    public class Database : INotifyPropertyChanged
    {
        public Database()
        {
            ...
            string url = "https://yqbhexgdvestykoednst.supabase.co";
            string key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlxYmhleGdkdmVzdHlrb2VkbnN0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NDg1ODQ1ODYsImV4cCI6MTk2NDE2MDU4Nn0.7YCXkQ92MgVIjhQ0Pr524qvsjzkhXez5kGvAACGbh1k";
